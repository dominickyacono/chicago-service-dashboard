...
# Data Loading 
try:
    chicago_areas = geopandas.read_file("data_files/Boundaries - Community Areas_20250802.geojson")
...
try:
    predictions_df = pd.read_csv("data_files/test_latest_counts_graphed_with_predictions.csv")
...
try:
    top_services_df = pd.read_csv("data_files/top_services_list.csv")
except Exception as e:
...
# create color bar at bottom of map
color_bar = ColorBar(
...
# interative JavaScript for callback
